...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "$POSTGRES_DB" <<-EOSQL
  ...
  BEGIN;
    ...
    INSERT INTO public."user" (id,nome,sobrenome,cpf,telefone,nascimento,email,senha,tipo_key,deleted_at,created_at,updated_at) VALUES
      ...
      (3,'Felipe','Valli','18917658091','5523223908','1996-12-05','felipe.valli@senac.com.br','\$2a\$10\$4E/PINxwmWijAFRXP66.dOTQBL5OdLOFg45pHafl.ggU8svzxBe5K','cliente',NULL,'2023-09-13 21:07:51.074898','2023-09-13 21:07:51.074898'),
